...
示例：`?method=GetSURL&key=QM&fn=F000001glaI72k8BQX.flac`
...
示例：`?method=GetLyric&songmid=001glaI72k8BQX&raw=1`
...
示例：`?method=GetSonglistById&id=12345678`
...
示例：`?method=GetSinger&singermid=0025NhlN2yWrP4`
...
示例：`?method=GetAlbum&albummid=0009C3rp3Kfwg0`
...
示例：`?method=GetMVURL&vid=q0034sb9eru&quality=4`
...
示例：`?method=GetSongDetail&songmid=001glaI72k8BQX`
...
示例：`?method=GetDigitalAlbumConfig&albummid=0009C3rp3Kfwg0`
...
示例：`?method=GetToplist&topid=129&updatekey=2020_1&type=global`
